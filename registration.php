                                ...
                                <div class="col-xl-12">
                                    <div class="input-field">
                                        ...
                                        <select name="country_origin" id="myCountry" onchange="myCountryFunction()" required>
                                            ...
                                            <option value="Democratic Republic of Congo">the Democratic Republic of Congo</option>
                                            ...
                                            <option value="French Southern Territories">French Southern Territories (the)</option>
                                            ...
                                            <option value="Holy See">Holy See (the)</option>
                                            ...
                                            <option value="Marshall Islands">Marshall Islands (the)</option>
                                ...
                                <div class="col-xl-12">
                                    <div class="input-field">
                                       ...
                                       <select name="Highest_degree" id="myDegree" onclick="myFunction()" required>
                                        ...
                                        <p id="demo"></p>
                                       <!-- <p><small> Discounted membership (for those with Bachelor, Master’s degree, MD): 20 dollars per year <br>
                                          Regular membership (for those with PhD or Other): 40 dollars per year </small></p>  -->
                                    </div>   
                                </div>
                                ...
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-xl-6 col-lg-6 col-sm-12">
                                            <button class="theme-btn btn-style-one" type="submit" name="submit_member_reg"><span>Submit</span></button>
                                        </div>
                                    </div>   
                                </div> 
                            </form>    
