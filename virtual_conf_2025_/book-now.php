...
<section class="banner page-banner position-relative pb-0">
  ...
  <div class="container">
    <div class="page-title text-center position-relative py-11">
     <h2 class="text-white">Book Tickets Now</h2>
    </div> 
  </div>
</section>
<!--Banner Section end-->
  ...
  <div class="container">
    <div class="booking-form w-lg-75 m-auto px-2">
      <div class="form-title mb-4">
        <h2 class="mb-2"><span class="pink">Event</span> Booking Form</h2>
...
<section class="direction bg-lightgrey">
  <div class="container">
