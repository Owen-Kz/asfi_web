            ...
            <div class="col-lg-6">
              <div class="overview-left text-center text-lg-start">
                <div class="overview-title pb-4">
                  ...
                  <p class="mb-2">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                </div> 
            ...
            <div class="row align-items-center">
              <div class="col-lg-6 col-md-6 px-2 pt-2">
                <div class="event-benifit-list-left mb-4">
                  <div class="benifit-list-box py-7 px-4 rounded mb-4 box-shadow bg-white">
                    <div class="list-box-icon">
                      <i class="fa fa-users pink mb-3" aria-hidden="true"></i>
                    </div> 
                    <div class="list-box-body">
                      <h5 class="mb-2">Event Conference</h5>
                      <p class="mb-2 w-75 m-auto">Duis aute irure dolor in reprehenderit</p>
                      <div class="box-btn">
                        <a class="p-0 pink" href="event-detail.php">Learn More<i class="fa fa-long-arrow-right ms-2"></i></a>
                      </div>  
                    </div>  
                  </div>
                  <div class="benifit-list-box py-7 px-4 rounded box-shadow bg-white">
                    <div class="list-box-icon">
                      <i class="fa fa-globe pink mb-3" aria-hidden="true"></i>
                    </div> 
                    <div class="list-box-body">
                      <h5 class="mb-2">Culture Leadership</h5>
                      <p class="mb-2 w-75 m-auto">Duis aute irure dolor in reprehenderit</p>
                      <div class="box-btn">
                        <a class="pink p-0" href="event-detail.php">Learn More<i class="fa fa-long-arrow-right ms-2"></i></a>
                      </div>  
                    </div>  
                  </div>
                </div>
              ...
              <div class="col-lg-6 col-md-6 px-2">
                <div class="benifit-list-box py-7 px-4 rounded box-shadow bg-white">
                  <div class="list-box-icon">
                    <i class="fa fa-bar-chart pink mb-3" aria-hidden="true"></i>
                  </div> 
                  <div class="list-box-body">
        ...
        <div class="col-lg-6 order-1 order-lg-2">
          <div class="event-benifit-list-right text-lg-start">
            <div class="overview-title pb-6">
              <p class="mb-1 pink">WHY ATTEND CONFERENCE</p>
              <h2 class="mb-2">What you’ll discover at <span class="pink">Events</span></h2>
            </div>
            <div class="overview-info">  
              ...
              <div class="overview-btn">
                <a class="btn my-4" href="event-detail.php">Join Event<i class="fa fa-long-arrow-right ms-4"></i></a>
              </div>      
            </div> 
          </div>  
        </div>
        ...
        <div class="row align-items-center ">
          ...
          <div class="col-lg-6">
            <div class="speaker-button text-lg-end">
              <a class="btn my-2" href="speaker_list.php">VIEW MORE SPEAKERS</a>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class=" col-lg-3 col-md-6 p-2">
              <div class="speaker-box  position-relative overflow-hidden text-white">
                  ...
                  <div class="box-content position-absolute bottom-0 z-1">
                      <h6 class="speaker-title d-block text-white pb-1"><a href="speaker_detail.php">GERARDO AMBROSE</a></h6>
  ...
  <div class="container">
    <div class="ticket-inner w-lg-75 mx-auto text-center position-relative text-white">
      <div class="ticket-title">
        ...
        <span class="spin pink d-inline-block">G</span><span class="spin pink d-inline-block">E</span><span class="spin pink d-inline-block">T</span> <span class="spin pink d-inline-block">T</span><span class="spin pink d-inline-block">I</span><span class="spin pink d-inline-block">C</span><span class="spin pink d-inline-block">K</span><span class="spin pink d-inline-block">E</span><span class="spin pink d-inline-block">T</span>
        </h1>
      </div>
      <div class="ticket-info">    
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.</p>
        <div class="ticket-button">
          <a class="btn btn1" href="book-now.php">GET TICKETS NOW</a>
        </div>  
      </div>
    </div>  
  </div>
 ...
 <section class="direction">
  <div class="container">
    <div class="section-title text-center pb-2 w-lg-60 m-auto">
      ...
      <p class="mb-0">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
      </p>
    </div>
      ...
      <div class="direction-info">
        <div class="row">
          ...
          <div class="col-lg-7 col-md-7 px-1 py-2" >
            <iframe height="400" class="rounded w-100" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=+(mangal%20bazar)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe>
          </div>
        </div>
      </div>
